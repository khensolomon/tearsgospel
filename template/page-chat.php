...
<?php if ( (function_exists( 'has_post_thumbnail' )) && ( has_post_thumbnail() ) ) :?>
	<div id="post-<?php the_ID(); ?>" <?php post_class('container-fluid abg'); ?> style="background-image:url(<?php the_post_thumbnail_url(); ?>);">
<?php else: ?>
...
<?php endif; ?>
	<div class="container col-sm-centered">
		<?php if ($imagesTotal) :?>
			...
			<div class="col-md-5 col-sm-5 display-cell">
				<h2><?php the_title(); ?></h2>
				<?php the_content(); ?>
			</div>
		</div>
